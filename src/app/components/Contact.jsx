...
export default function Contact() {
  ...
  return (
    <section className="mb-32 container bg-gradient-to-b from-blue-50 to-white mx-auto py-10">
      <h3 className="text-blue-500 text-center font-cursive text-2xl mb-2">Contact Us</h3>
      ...
      <div className="relative h-[300px] overflow-hidden bg-cover bg-[50%] bg-no-repeat bg-blue-100 container mx-auto">
        <iframe
      ...
      <div className="container px-6 md:px-12 mx-auto">
        <div className="block rounded-lg bg-[hsla(0,0%,100%,0.8)] px-6 py-12 shadow-[0_2px_15px_-3px_rgba(0,0,0,0.07),0_10px_20px_-2px_rgba(0,0,0,0.04)] dark:bg-[hsla(0,0%,5%,0.7)] dark:shadow-black/20 md:py-16 md:px-12 -mt-[100px] backdrop-blur-[30px] border border-gray-300">
